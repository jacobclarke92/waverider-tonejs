...
class AppDB extends Dexie {
	...
	constructor() {
		...
		this.files.mapToClass(FileEntity)
	}
}
...
export const updateBy = (table:string, field:string | string[], value: IndexableType, updates: {[key: string]: any} = {}) =>
	new Promise((resolve, reject) =>
		db
			.table(table)
			.where(field)
...
export const getFileBy = (field: string | string[], value: any) => getBy('files', field, value)
export const getFileById = (id: number) => getFileBy('id', id)
export const getFileByHash = (hash: string) => getFileBy('hash', hash)
export const updateFileBy = (field: string | string[], value: any, updates: {[key: string]: any} = {}) => updateBy('files', field, value, updates)
export const updateFileById = (id: number, updates: {[key: string]: any}) => updateById('files', id, updates)
export const updateFileByHash = (hash:string, updates: {[key: string]: any}) => updateBy('files', 'hash', hash, updates)
